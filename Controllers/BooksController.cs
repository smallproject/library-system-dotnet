...
namespace library_system_dotnet.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ISBN,Title,Description,Author,PublishedYear,Genre,CopiesAvailable,TotalCopies,Location,CoverImageUrl,Id,CreatedAt,UpdatedAt")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ISBN,Title,Description,Author,PublishedYear,Genre,CopiesAvailable,TotalCopies,Location,CoverImageUrl,Id,CreatedAt,UpdatedAt")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
